...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            optionsWrap.on('click', '.clear', function( event ){
                ...
                $('.ms-options-wrap.ms-active > .ms-options').each(function(){
                    ...
                    $('#'+$(this).closest('.ms-options-wrap').siblings('select').attr('id')).trigger('dclick');
            ...
            $(document).off('click.ms-hideopts').on('click.ms-hideopts', function( event ){
                if( !$(event.target).closest('.ms-options-wrap').length ) {
                    $('.ms-options-wrap.ms-active > .ms-options').each(function(){
                        ...
                        //alert($('#'+$(this).closest('.ms-options-wrap').siblings('select').attr('id')).attr('class'));
                        $('#'+$(this).closest('.ms-options-wrap').siblings('select').attr('id')).trigger('dclick');
                        // USER CALLBACK
                        if( typeof thisInst.options.onControlClose == 'function' ) {
                            thisInst.options.onControlClose( thisInst.element );
            ...
            if( instance.options.selectAll ) {
                optionsList.before('<a href="#" class="clear">Apply</a>');
                optionsList.after('<a href="#" class="clear">Apply</a>');
            }
