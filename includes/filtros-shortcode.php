...
class Filtros_Shortcode {
    ...
    function Contenidos($atts) {
        ...
        wp_enqueue_script( 'filtros-shortcode61111',WP_PLUGIN_URL . '/filtros/js/jquery.jqgrid.min.js', ['jquery'],'5.9.28'  );
...
';
        ...
        <div class="a1 col-md-10">
            ...
            <select class="form-control" id="voltage" multiple="multiple">
                <option value="">Voltage (DC)</option>
            </select>
            </div>
            
            
            <div style="width:18%;" class="le">
            <select class="form-control" id="voltage-ca" multiple="multiple">
                <option value="">Voltage (AC)</option>
            </select>
            </div>
        ...
        <div class="col-md-12">
            ...
            <div class="le fil">
                <select class="form-control" id="width" multiple="multiple">
            ...
            <div class="le fil2">
                <select class="form-control" id="lead" multiple="multiple">
                    <option value="">Lead Spacing (mm)</option>
                </select>
            </div>
            ...
            <div class="le fil3">
                <select class="form-control" id="dv" multiple="multiple">
                    <option value="">dv/dt</option>
                </select>
            </div>
